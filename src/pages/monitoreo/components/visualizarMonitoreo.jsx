...
const VisualizarMonitoreo = () => {
  const [lotes, setSensors] = useState([
  ...
  const [espacios, setActuators] = useState([
  ...
  return (
    <div>
      <div className="flex justify-between items-center p-5 border-b">
        <h2 className="text-xl font-semibold">Sistema 1</h2>
      ...
      <div className="space-y-4">
        <div className="border border-gray-200 rounded-lg">
          ...
          >
            <span className="text-sm font-semibold">Lotes de Producción</span>
          ...
          {expandedSection === 'sensores' && renderDeviceTable(lotes, 'sensor')}
        </div>
        <div className="border border-gray-200 rounded-lg">
          <button
          ...
          >
            <span className="text-sm font-semibold">Espacios de Producción</span>
          ...
          {expandedSection === 'actuadores' && renderDeviceTable(espacios, 'actuador')}
        </div>
      </div>
...
VisualizarMonitoreo.propTypes = {
  lotes: PropTypes.arrayOf(PropTypes.shape(DevicePropTypes)),
  espacios: PropTypes.arrayOf(PropTypes.shape(DevicePropTypes)),
};
